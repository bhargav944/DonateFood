...
import com.bhargav.verifyproject.adapters.AdapterComments;
import com.bhargav.verifyproject.models.ModelComment;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this,"com.bhargav.verifyproject.fileprovider",file);
        }
        catch (Exception e) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                    ...
                    pLikesTv.setText(pLikes + " Accept");
